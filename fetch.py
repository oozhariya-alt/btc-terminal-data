...
H = {"User-Agent": "Mozilla/5.0"}                                                                                                                                                  B = "https://query1.finance.yahoo.com/v8/finance/chart/"
...
wh = requests.get("https://community-api.coinmetrics.io/v4/timeseries/asset-metrics?assets=btc&metrics=AdrBalNtv1KCnt&page_size=1", headers=H, timeout=15).json()
cnt = int(float(wh["data"][0]["AdrBalNtv1KCnt"]))

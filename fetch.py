...
try: wh = requests.get("https://community-api.coinmetrics.io/v4/timeseries/asset-metri  cs?assets=btc&metrics=AdrBalNtv1KCnt&page_size=1", headers=H, timeout=15).json();
